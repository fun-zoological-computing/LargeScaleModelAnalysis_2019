...
def dash_plot_ephys_clusters(display_prop_1,display_prop_2,display_prop_3,dash_container=0,
    ...
    model_ids = metadata_df['Model_ID'].tolist() # change to text box
    # model_names = metadata_df['Name'].tolist()
    cluster_names = metadata_df['Cluster'].tolist()
    pubs = metadata_df['Publication'].tolist()
